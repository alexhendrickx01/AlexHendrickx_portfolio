...
export const projects: Project[] = [
  {
    ...
    description: 'Elektriciens en andere vakmensen verliezen dagelijks tijd aan papierwerk dat niet past bij hoe zij werken. Factuurt digitaliseert de volledige workflow (offerte, timers, materiaal, factuur) voor gebruik op de werf, ook zonder internet.',
  ...
  },
  {
    ...
    tagline: 'GDPR-compliant AI-assistent voor treindispecheristen: realtime, volledig lokaal.',
