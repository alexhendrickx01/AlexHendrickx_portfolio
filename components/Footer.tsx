...
export default function Footer() {
  return (
    <footer className="relative border-t border-[#2D3748]/50 bg-[#0A0D14]">
      <div className="mx-auto max-w-6xl px-6 py-12">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-3">

          {/* Left — identity */}
          <div className="flex flex-col gap-2">
            <span className="text-base font-bold text-[#F1F5F9]">Alex Hendrickx</span>
            <span className="text-sm text-[#94A3B8]">Bachelor Informatica · Thomas More 2025</span>
          </div>
        ...
        {/* Bottom bar */}
        <div className="mt-10 border-t border-[#2D3748]/40 pt-6 text-center text-xs text-[#94A3B8]">
          © 2025 Alex Hendrickx · Graduation Portfolio
        </div>
      </div>
    </footer>
  )
